            ...
            <form onSubmit={sendEmail}>
              ...
              <div class="row p-top-md">
                <div class="col-xs-12 form-group has-error">
                  ...
                  <input type="text" name="name" required="" class="form-control" /><span class="help-block text-base"><span class="fa fa-exclamation-circle">&nbsp;</span>Please provide your name</span>
              ...
              <div class="row">
                <div class="col-xs-12 form-group has-error">
                  ...
                  <input type="text" max="10" name="mobile" required="" class="form-control" /><span class="help-block text-base"><span class="fa fa-exclamation-circle">&nbsp;</span>Please provide your mobile number</span>
              ...
              <div class="row">
                <div class="col-xs-12 form-group has-error">
                  ...
                  <input type="email" name="email" required="" class="form-control" /><span class="help-block text-base"><span class="fa fa-exclamation-circle">&nbsp;</span>Please provide your email ID</span>
              ...
              <div class="row">
                <div class="col-xs-12 form-group has-error">
                  ...
                  <input type="text" name="subject" required="" class="form-control" /><span class="help-block text-base"><span class="fa fa-exclamation-circle">&nbsp;</span>This field cannot be empty</span>
              ...
              <div class="row">
                ...
                <span class="help-block text-base"><span class="fa fa-exclamation-circle">&nbsp;</span>Please write your message</span></div>
              </div>
